...
const dialNumber = "+919876543210";    // tel: link
            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-center">
                ...
                <div>
                    ...
                    <p className="text-slate-300 text-base sm:text-lg lg:text-xl text-center md:text-left mb-8 max-w-2xl mx-auto md:mx-0 font-body">
                        Call our dermatologist now and take the first step toward radiant, confident skin and hair.
                    </p>
                ...
                <div className="flex justify-center md:justify-end">
                    <a
                        href={`tel:${dialNumber}`}
                        className="w-full max-w-md flex items-center gap-6 bg-blue-50 border border-blue-100 px-6 py-6 rounded-2xl hover:bg-blue-100 transition group shadow-lg"
                    >
                        {/* Icon */}
                        <div className="bg-blue-600 text-white w-14 h-14 flex items-center justify-center rounded-full text-2xl group-hover:scale-105 transition">
                            📞
                        </div>
